...
```swift
.package(url: "https://github.com/nanograph/nanograph-swift", from: "0.10.0")
```
...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "NanoGraphFFI",
            url: "https://github.com/nanograph/nanograph/releases/download/v0.10.0/NanoGraphFFI.xcframework.zip",
            checksum: "<sha256>"
        ),
        .target(
            name: "CNanoGraph",
